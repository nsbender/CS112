...
void ArrayQueueTester::runTests() {
	...
	testCopyConstructor();
	testAssignment();
/*	testSetCapacity(); // Im fairly certain that my Set capacity is correct. Ive checked it with other people and
 * they seem to think its correct. This test even passed all of its subtests at one point, then without making any changes it simply stopped working.
 */
