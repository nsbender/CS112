...
void MatrixTester::testDefaultConstructor() {
	//Tests default constructor of Matrix
...
void MatrixTester::testExplicitConstructor() {
	//Tests explicit constructor of Matrix
...
void MatrixTester::testCopyConstructor() {
	//Tests copy constructor of Matrix
	cout << "Testing copy constructor... " << flush;
	// copy empty matrix
	Matrix<Item> m1;
	Matrix<Item> m2 = Matrix<Item>(m1);
	assert( m2.getRows() == 0 );
	assert( m2.getColumns() == 0 );
...
void MatrixTester::testAssignment() {
	//Tests assignment operator of Matrix
	cout << "Testing =... " << flush;
	// empty to empty
	Matrix<Item> m0;
	Matrix<Item> m1;
...
void MatrixTester::testEquality() {
	//Tests equality operator of Matrix
	cout << "Testing ==... " << flush;
	// empty
	Matrix<Item> m1;
	Matrix<Item> m2;
...
void MatrixTester::testReadSubscript(const Matrix<Item>& mat) {
	//Tests read only (const) subscript operator of Matrix
...
void MatrixTester::testSubscripts() {
	//Tests write (full access) subscript operator of Matrix, runs read only test
...
void MatrixTester::testInequality() {
	//tests inequality operator of Matrix
	cout << "Testing !=... " << flush;
